#coding=UTF8
"""
El proposito de este experimento es analizar la convergencia del método de la
Secante para diferentes magnitudes de x0 y de alphas.
...
for alpha in alphas:
    ...
    new_x1s = deepcopy(x1s)
    mi_newton = Newton(entradas=[alpha] * len(new_x0s), x0s=new_x0s, x1s=new_x1s)
    mi_newton.run()
